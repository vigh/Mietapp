...
public class CaptureSignature extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Cursor oneCursor = mDatabase.rawQuery("SELECT ID FROM CUSTOMER_TABLE ORDER BY ID DESC LIMIT 1 ", null);
        ...
        uniqueId = String.valueOf(customer.getId());

        super.onCreate(savedInstanceState);
        this.requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.signature_view);

        tempDir = Environment.getDataDirectory() + "/" + getResources().getString(R.string.external_dir) + "/";
...
//        uniqueId = getTodaysDate() + "_" + getCurrentTime() + "_" + Math.random();
        ...
        mContent.addView(mSignature, MATCH_PARENT, MATCH_PARENT);
